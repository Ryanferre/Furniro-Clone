...
var esES = {
  ...
  unstable__errors: {
    ...
    phone_number_exists: "Este n\xFAmero de tel\xE9fono est\xE1 ocupado. Por favor, prueba con otro.",
    zxcvbn: {
      couldBeStronger: "Tu contrase\xF1a funciona, pero podr\xEDa ser m\xE1s fuerte. Intenta a\xF1adir m\xE1s caracteres.",
      ...
      suggestions: {
        allUppercase: "Escribe en may\xFAsculas algunas, pero no todas las letras.",
        anotherWord: "A\xF1ade m\xE1s palabras que sean menos comunes.",
        associatedYears: "Evita a\xF1os asociados contigo.",
        capitalization: "Escribe en may\xFAsculas alguna letra m\xE1s adem\xE1s de la primera.",
        dates: "Evita fechas que est\xE9n asociadas contigo.",
