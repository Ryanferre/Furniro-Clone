...
import QRpage from "../QRcode/QRcode"
    ...
    return(
        ...
        <section>
            ...
            <div className="py-[60px] px-[150px] h-[900px] flex flex-row justify-between">
                ...
                <div className="w-[450px] flex flex-col h-full gap-3">
                    <div>
                    ...
                    <button className="border flex items-center justify-around bg-white py-2 px-8 w-max rounded-[8px] shadow cursor-pointer">Comprar</button>
                    <QRpage />
                </div>
            </div>
        </section>
