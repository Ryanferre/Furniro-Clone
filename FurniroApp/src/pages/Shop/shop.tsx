...
const ShopItens= ()=>{
    ...
    const [quantIten, setQuant]= useState <number | null>(16)//quantidade de itens por pagina
         ...
         <section className="mb-4">
            <div className="w-full h-[310px] bg-contain flex flex-col items-center justify-center" style={{backgroundImage: 'url(https://i.postimg.cc/Vk5jnHQM/Shop-Banner.png'}}>
                ...
                <div className="flex flex-row items-center justify-around w-[120px]">
                    ...
                    <p className="text-3 lg:text-[18px]">Shop</p>
                </div>
            </div>

            <section className="flex flex-row bg-[#F9F1E7] py-5 px-4 lg:px-20 items-center relative justify-between">
               
                <div className="flex flex-row items-center justify-around w-80 gap-3 lg:gap-0 lg:w-[400px]">
                    <button className="flex flex-row items-center gap-[10px]" onClick={checkedMove}>
                        ...
                        <p className="text-3 lg:text-[18px]">Filter</p>
                    </button>
                    <svg className="hidden lg:flex" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="hidden lg:flex" width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="border-l-2 border-[#9F9F9F] px-3 lg:px-0 lg:pr-3 lg:indent-3">16 of 32 results</p>
                </div>

                <div className="flex flex-row w-74 lg:w-[285px] justify-between">
                    <label className="flex flex-row items-center w-17 lg:w-[90px] justify-between ">
                        <p>Show</p>
                        <span className="py-[6px] px-2 lg:px-[14px] flex flex-row justify-center gap-3 bg-white"><p>0</p></span>
                    </label>
                    <label className="flex flex-row items-center w-[175px] justify-center gap-2 lg:gap-0 lg:justify-between">
                        <p>Short by</p>
                        <span className="w-[100px] py-[6px] pl-2 lg:pl-3 flex flex-row justify-start gap-3 bg-white"><p>Default</p></span>
                    </label>
                </div>
            </section>
